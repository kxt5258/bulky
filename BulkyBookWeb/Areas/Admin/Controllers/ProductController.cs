...
namespace BulkyBook.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(ProductVM obj, IFormFile? file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(file != null)
                {
                    ...
                    using (var fileStream = new FileStream(Path.Combine(uplaods, fileName + ext), FileMode.Create))
                    {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            Product objFromDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == id);
            ...
            {
                string wwwRootPath = _hostEnvironment.WebRootPath;
                var oldImage = Path.Combine(wwwRootPath, objFromDb.ImageUrl.TrimStart('/'));
                if (System.IO.File.Exists(oldImage))
                {
                    System.IO.File.Delete(oldImage);
                }
